...
crudini --set /etc/nova/nova.conf DEFAULT my_ip 10.38.70.11
...
crudini --set /etc/nova/nova.conf vnc vncserver_listen 10.38.70.11
crudini --set /etc/nova/nova.conf vnc vncserver_proxyclient_address 10.38.70.11
