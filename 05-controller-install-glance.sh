...
crudini --set /etc/glance/glance-api.conf database connection mysql+pymysql://glance:${ADMIN_PASSWORD}@controller/glance
...
crudini --set /etc/glance/glance-registry.conf database connection mysql+pymysql://glance:${ADMIN_PASSWORD}@controller/glance
