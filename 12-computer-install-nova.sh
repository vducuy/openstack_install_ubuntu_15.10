...
crudini --set /etc/nova/nova.conf DEFAULT my_ip 10.38.70.21
...
crudini --set /etc/nova/nova.conf vnc my_ip 10.38.70.21
crudini --set /etc/nova/nova.conf vnc vncserver_listen 0.0.0.0
crudini --set /etc/nova/nova.conf vnc vncserver_proxyclient_address 10.38.70.21
